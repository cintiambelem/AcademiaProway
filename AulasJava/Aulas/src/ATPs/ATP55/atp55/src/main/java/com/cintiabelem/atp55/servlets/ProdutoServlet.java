...
import com.cintiabelem.atp55.models.ProdutoModel;
...
public class ProdutoServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (parametroValor != null && parametroCategoria_id != null) {
            ...
            prod1.setId_categoria(Integer.parseInt(parametroCategoria_id));
            
            out.printf("produto - produto = %s - valor: %.2f - id categoria: %d", prod1.getNome(), prod1.getValor(), prod1.getId_categoria());
        } else {
